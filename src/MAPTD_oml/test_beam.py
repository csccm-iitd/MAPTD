...
-- The environment surrogate model (i.e. pre-trained WNO) is updated online
"""
...
from algorithm.test_maptd_oml import MAPTD_oml
from algorithm.helper import Episode, ReplayBuffer
from beam_control_nn import WNO1d
import logger
import matplotlib.pyplot as plt
torch.backends.cudnn.benchmark = True
__CONFIG__, __LOGS__, task_name = 'cfgs', 'logs', 'beam_test'
...
env, agent, buffer = make_env(cfg), MAPTD_oml(cfg), ReplayBuffer(cfg)

agent.load('logs/beam-EulerBeam/default/1/models/model.pt')
...
# Save the results,
# -------------------------------------------------
sp.io.savemat('results/beam_control_oml.mat', mdict={'xt_controlled':disp,
