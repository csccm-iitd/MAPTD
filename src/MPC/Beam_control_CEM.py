...
agent = CEM(action_dim=env.action_dim, horizon=env.phorizon, num_samples=256, 
            bounds=bounds, num_elites=64, iterations=100)
...
# %%
# Save the results,
sio.savemat('results/beam_mpc_cem.mat', mdict={'xt':xt,
                                            'xtHistory':xtHistory,
                                            'uHistory':uHistory,
                                            'fHistory':fHistory,
                                            'tHistory':tHistory,
