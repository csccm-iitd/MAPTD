...
start  = 0.1
CT     = T                # Run control for 100 time units
Force  = env.force_fun
...
agent = CEM(action_dim=env.action_dim, horizon=env.phorizon, num_samples=128, 
            bounds=bounds, num_elites=64, iterations=20)
...
# %%
# Save the results,
sio.savemat('results/structure_mpc_cem.mat', mdict={'xt':xt,
                                                'xtHistory':xtHistory,
                                                'uHistory':uHistory,
                                                'fHistory':fHistory,
                                                'tHistory':tHistory,
