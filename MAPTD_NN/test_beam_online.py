...
__CONFIG__, __LOGS__, task_name = 'cfgs', 'logs', 'beam_online'
...
agent.load('logs/beam-EulerBeam/online/1/models/model.pt')
...
# Save the results,
# -------------------------------------------------
sp.io.savemat('results/MAPTD_NN_beam_online.mat', mdict={'xt_controlled':disp,
                                                  'xt_uncontrolled':true_disp,
                                                  'rewards':rewards,
                                                  'actions':actions})
sp.io.savemat('results/time_beam_online.mat', mdict={'time':time}) 
