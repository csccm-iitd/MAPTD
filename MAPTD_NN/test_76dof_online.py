...
-- The environment model is learned using a NN in online
"""
...
from algorithm.test_maptd_online_nn import MAPTD_nn
from algorithm.helper import Episode, ReplayBuffer
import logger
import matplotlib.pyplot as plt
torch.backends.cudnn.benchmark = True
__CONFIG__, __LOGS__, task_name = 'cfgs', 'logs', 'structure_rom_online'
...
agent.load('logs/structure-Skyscraper_rom/online/1/models/model.pt')
...
# Save the results,
# -------------------------------------------------
sp.io.savemat('results/MAPTD_NN_structure_online.mat', mdict={'xt_controlled':xt_controlled,
                                                      'xt_uncontrolled':xt_uncontrolled,
                                                      'rewards':rewards,
                                                      'actions':actions})
sp.io.savemat('results/time_skyscraper_online.mat', mdict={'time':time}) 
