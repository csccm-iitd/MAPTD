...
-- The environment model is trained offline and loaded from a saved instance
"""
...
from algorithm.test_maptd_offline_nn import MAPTD_nn
from algorithm.helper import Episode, ReplayBuffer
import logger
import matplotlib.pyplot as plt
torch.backends.cudnn.benchmark = True
__CONFIG__, __LOGS__, task_name = 'cfgs', 'logs', 'structure_rom_offline'
...
env, agent, buffer = make_env(cfg), MAPTD_nn(cfg), ReplayBuffer(cfg)

agent.load('logs/structure-Skyscraper_rom/offline/1/models/model.pt')
...
# Save the results,
# -------------------------------------------------
sp.io.savemat('results/MAPTD_NN_structure_offline.mat', mdict={'xt_controlled':xt_controlled,
                                                      'xt_uncontrolled':xt_uncontrolled,
                                                      'rewards':rewards,
                                                      'actions':actions})
sp.io.savemat('results/time_skyscraper_offline.mat', mdict={'time':time}) 
